...
With the parameters that have been evaluated in the previous chapters, the car stops at 1.905 m.

The following Figure \ref{fig:D10} shows the simulation results. The upper channel of the oscilloscope shows the velocity that becomes zero once it is below 0.29 km/h after approximately 1.4 s (R5).
...
The third subplot shows the covered distance of the car, which is clearly under the 2 m mark (R1). 
