...
%% des Dokuments.
\setzemartrikelnr{8540946; XXX}
\setzekurs{STG-TINF17-ITA}
\setzetitel{Dokumentation Parkassist}
...
\setzedhbw{Stuttgart}
\setzebetreuer{Dr. Kai Pinnow}
\setzegutachter{nothing}
\setzezeitraum{24.03.2020 - 07.04.2020}
\setzearbeit{Graphische Programmierung und Simulation}
\setzeautor{Nahku Saidy und Hanna Siegfried}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
